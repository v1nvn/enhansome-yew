...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,460 | 🐛 126 | 🌐 Rust | 📅 2026-03-07

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,460 | 🐛 126 | 🌐 Rust | 📅 2026-03-07 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,460 | 🐛 126 | 🌐 Rust | 📅 2026-03-07 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,460 | 🐛 126 | 🌐 Rust | 📅 2026-03-07 - Smaller examples included in official repo.
...
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,716 | 🐛 86 | 🌐 Rust | 📅 2026-03-06 - Zoom clone written in rust for research purposes.
...
* [Realworld example](https://github.com/jetli/rust-yew-realworld-example-app) ⭐ 890 | 🐛 6 | 🌐 Rust | 📅 2025-12-28 - Exemplary real world app built with Rust + Yew + WebAssembly. It utilizes Yew's latest `function components` and `hooks`. It also supports desktop application powered by [Tauri](https://github.com/tauri-apps/tauri) ⭐ 103,768 | 🐛 1,378 | 🌐 Rust | 📅 2026-03-07.
* [PinePods](https://github.com/madeofpendletonwool/PinePods) ⭐ 808 | 🐛 131 | 🌐 Rust | 📅 2026-02-24 - PinePods is a Rust based podcast management system that manages podcasts with multi-user support and relies on a central database with clients to connect to it.
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 459 | 🐛 9 | 🌐 Rust | 📅 2026-03-06 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
...
* [simply-view-image-for-python-debugging](https://github.com/elazarcoh/simply-view-image-for-python-debugging?tab=readme-ov-file) ⭐ 72 | 🐛 31 | 🌐 Rust | 📅 2026-03-07 - Visual studio code extension simply view the image of the image variables when debugging python.
...
* [Rust Audio](https://github.com/austintheriot/audio) ⭐ 56 | 🐛 2 | 🌐 Rust | 📅 2026-03-08 - Realtime audio processing / synthesis using Rust/WASM in the browser, [Live Demo](https://austintheriot.github.io/audio/).
...
* [rust-yew-axum-tauri-desktop](https://github.com/jetli/rust-yew-axum-tauri-desktop) ⭐ 163 | 🐛 0 | 🌐 Rust | 📅 2025-02-17 - Rust + Yew + Axum + Tauri, full-stack Rust development for Desktop apps.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 103,768 | 🐛 1,378 | 🌐 Rust | 📅 2026-03-07 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,380 | 🐛 518 | 🌐 WebAssembly | 📅 2026-03-07 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
...
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,110 | 🐛 392 | 🌐 Rust | 📅 2026-03-03 - Your favorite Rust -> WebAssembly workflow tool.
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,201 | 🐛 130 | 🌐 Rust | 📅 2026-03-05 - Build, bundle & ship your Rust Wasm application to the web.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 35,176 | 🐛 661 | 🌐 Rust | 📅 2026-03-02 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 20,327 | 🐛 131 | 🌐 Rust | 📅 2026-03-07 - Build fast web applications with Rust.
* [Seed](https://github.com/seed-rs/seed) ⭐ 3,835 | 🐛 55 | 🌐 Rust | 📅 2025-01-11 - A Rust framework for creating web apps.
* [Sycamore](https://github.com/sycamore-rs/sycamore) ⭐ 3,202 | 🐛 34 | 🌐 Rust | 📅 2025-12-02 - A reactive library for creating web apps in Rust and WebAssembly.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 56,053 | 🐛 11 | 🌐 Rust | 📅 2026-03-07 - A curated list of Rust code and resources.
