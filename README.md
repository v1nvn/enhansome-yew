...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,400 | 🐛 152 | 🌐 Rust | 📅 2026-02-06

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,400 | 🐛 152 | 🌐 Rust | 📅 2026-02-06 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,400 | 🐛 152 | 🌐 Rust | 📅 2026-02-06 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,400 | 🐛 152 | 🌐 Rust | 📅 2026-02-06 - Smaller examples included in official repo.
...
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,697 | 🐛 60 | 🌐 Rust | 📅 2026-02-04 - Zoom clone written in rust for research purposes.
...
* [Sentry Relay](https://github.com/getsentry/relay) ⭐ 361 | 🐛 100 | 🌐 Rust | 📅 2026-02-06 - The Sentry Relay is a service that pushes some functionality from the Sentry SDKs as well as the Sentry server into a proxy process.
...
* [Taxy](https://github.com/picoHz/taxy/tree/main) ⭐ 192 | 🐛 3 | 🌐 Rust | 📅 2025-04-06 - A reverse proxy server with built-in WebUI, supporting TCP/HTTP/TLS/WebSocket, written in Rust.
...
* [live-ask.com](https://github.com/liveask/liveask) ⭐ 104 | 🐛 8 | 🌐 Rust | 📅 2026-01-26 - Realtime Event/Meetup Q\&A Platform. [Live at live-ask.com](https://live-ask.com).
...
* [simply-view-image-for-python-debugging](https://github.com/elazarcoh/simply-view-image-for-python-debugging?tab=readme-ov-file) ⭐ 71 | 🐛 16 | 🌐 Rust | 📅 2026-01-29 - Visual studio code extension simply view the image of the image variables when debugging python.
...
* [yew-bootstrap](https://github.com/isosphere/yew-bootstrap) ⭐ 44 | 🐛 13 | 🌐 Rust | 📅 2026-02-03 - A Yew wrapper for the Bootstrap 5 component library.
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 7 | 🌐 Rust | 📅 2026-02-01 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 43,929 | 🐛 650 | 🌐 TypeScript | 📅 2026-01-20 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,907 | 🐛 266 | 🌐 TypeScript | 📅 2026-02-02.
* [Bounce](https://github.com/bounce-rs/bounce) ⭐ 100 | 🐛 16 | 🌐 Rust | 📅 2024-01-22 - The uncomplicated state management library for Yew, inspired by [Redux](https://github.com/reduxjs/redux) ⭐ 61,449 | 🐛 43 | 🌐 TypeScript | 📅 2026-02-04 and [Recoil](https://github.com/facebookexperimental/Recoil) ⚠️ Archived.
...
* [Plotly.rs](https://github.com/igiagkiozis/plotly) ⭐ 1,396 | 🐛 9 | 🌐 Rust | 📅 2026-02-06 - Rust bindings for the popular [Plotly](https://plotly.com/javascript/) charting library.
...
* [stylist-rs](https://github.com/futursolo/stylist-rs) ⭐ 379 | 🐛 21 | 🌐 Rust | 📅 2024-08-14 - A CSS-in-Rust styling solution for WebAssembly Applications.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 8,840 | 🐛 541 | 🌐 Rust | 📅 2026-02-07 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,323 | 🐛 505 | 🌐 WebAssembly | 📅 2026-02-07 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 7,843 | 🐛 205 | 🌐 C++ | 📅 2026-01-21 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,069 | 🐛 388 | 🌐 Rust | 📅 2026-02-05 - Your favorite Rust -> WebAssembly workflow tool.
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,147 | 🐛 129 | 🌐 Rust | 📅 2026-02-02 - Build, bundle & ship your Rust Wasm application to the web.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 34,584 | 🐛 635 | 🌐 Rust | 📅 2026-02-07 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 19,904 | 🐛 137 | 🌐 Rust | 📅 2026-02-07 - Build fast web applications with Rust.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 55,473 | 🐛 12 | 🌐 Rust | 📅 2026-02-06 - A curated list of Rust code and resources.
* [Awesome WebAssembly](https://github.com/mbasso/awesome-wasm) ⭐ 9,473 | 🐛 45 | 📅 2024-11-15 - Collection of awesome things regarding WebAssembly ecosystem.
