...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,459 | 🐛 123 | 🌐 Rust | 📅 2026-03-10

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,459 | 🐛 123 | 🌐 Rust | 📅 2026-03-10 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,459 | 🐛 123 | 🌐 Rust | 📅 2026-03-10 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,459 | 🐛 123 | 🌐 Rust | 📅 2026-03-10 - Smaller examples included in official repo.
...
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,717 | 🐛 90 | 🌐 Rust | 📅 2026-03-09 - Zoom clone written in rust for research purposes.
...
* [Realworld example](https://github.com/jetli/rust-yew-realworld-example-app) ⭐ 890 | 🐛 6 | 🌐 Rust | 📅 2025-12-28 - Exemplary real world app built with Rust + Yew + WebAssembly. It utilizes Yew's latest `function components` and `hooks`. It also supports desktop application powered by [Tauri](https://github.com/tauri-apps/tauri) ⭐ 103,910 | 🐛 1,379 | 🌐 Rust | 📅 2026-03-09.
* [PinePods](https://github.com/madeofpendletonwool/PinePods) ⭐ 812 | 🐛 133 | 🌐 Rust | 📅 2026-03-09 - PinePods is a Rust based podcast management system that manages podcasts with multi-user support and relies on a central database with clients to connect to it.
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 462 | 🐛 9 | 🌐 Rust | 📅 2026-03-06 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
...
* [Sentry Relay](https://github.com/getsentry/relay) ⭐ 364 | 🐛 100 | 🌐 Rust | 📅 2026-03-09 - The Sentry Relay is a service that pushes some functionality from the Sentry SDKs as well as the Sentry server into a proxy process.
...
* [Kiomet](https://github.com/SoftbearStudios/kiomet) ⭐ 158 | 🐛 5 | 🌐 Rust | 📅 2025-09-10 - An online real-time strategy game in which you expand your territory by capturing towers.
* [Google Wasefire](https://github.com/google/wasefire) ⭐ 154 | 🐛 64 | 🌐 Rust | 📅 2026-03-05 - Secure firmware framework focusing on developer experience.
...
* [chipbox](https://github.com/chipnertkj/chipbox) ⭐ 128 | 🐛 10 | 🌐 Rust | 📅 2026-02-05 - chipbox is an open-source desktop DAW written in Rust.
...
* [simply-view-image-for-python-debugging](https://github.com/elazarcoh/simply-view-image-for-python-debugging?tab=readme-ov-file) ⭐ 72 | 🐛 17 | 🌐 Rust | 📅 2026-03-09 - Visual studio code extension simply view the image of the image variables when debugging python.
...
* [Oxfeed](https://github.com/sanpii/oxfeed) ⭐ 14 | 🐛 3 | 🌐 Rust | 📅 2026-03-09 - A feed reader written in Rust with a Yew frontend.
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 7 | 🌐 Rust | 📅 2026-02-24 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 43,950 | 🐛 653 | 🌐 TypeScript | 📅 2026-01-20 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,930 | 🐛 269 | 🌐 TypeScript | 📅 2026-02-10.
* [Bounce](https://github.com/bounce-rs/bounce) ⭐ 100 | 🐛 17 | 🌐 Rust | 📅 2024-01-22 - The uncomplicated state management library for Yew, inspired by [Redux](https://github.com/reduxjs/redux) ⭐ 61,443 | 🐛 43 | 🌐 TypeScript | 📅 2026-03-06 and [Recoil](https://github.com/facebookexperimental/Recoil) ⚠️ Archived.
...
* [yew-side-effect](https://github.com/futursolo/yew-side-effect) ⚠️ Archived - Reconcile Side Effects in Yew Applications, inspired by [react-side-effect](https://github.com/gaearon/react-side-effect) ⭐ 1,220 | 🐛 15 | 🌐 JavaScript | 📅 2023-03-04 and [react-helmet](https://github.com/nfl/react-helmet) ⭐ 17,492 | 🐛 220 | 🌐 JavaScript | 📅 2023-07-18.
...
* [stylist-rs](https://github.com/futursolo/stylist-rs) ⭐ 379 | 🐛 27 | 🌐 Rust | 📅 2026-02-23 - A CSS-in-Rust styling solution for WebAssembly Applications.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 8,891 | 🐛 540 | 🌐 Rust | 📅 2026-03-08 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 103,910 | 🐛 1,379 | 🌐 Rust | 📅 2026-03-09 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,385 | 🐛 524 | 🌐 WebAssembly | 📅 2026-03-10 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 7,895 | 🐛 212 | 🌐 C++ | 📅 2026-03-06 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,112 | 🐛 391 | 🌐 Rust | 📅 2026-03-03 - Your favorite Rust -> WebAssembly workflow tool.
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,205 | 🐛 130 | 🌐 Rust | 📅 2026-03-09 - Build, bundle & ship your Rust Wasm application to the web.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 35,212 | 🐛 656 | 🌐 Rust | 📅 2026-03-09 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 20,354 | 🐛 135 | 🌐 Rust | 📅 2026-03-09 - Build fast web applications with Rust.
* [Seed](https://github.com/seed-rs/seed) ⭐ 3,835 | 🐛 55 | 🌐 Rust | 📅 2025-01-11 - A Rust framework for creating web apps.
* [Sycamore](https://github.com/sycamore-rs/sycamore) ⭐ 3,203 | 🐛 34 | 🌐 Rust | 📅 2025-12-02 - A reactive library for creating web apps in Rust and WebAssembly.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 56,078 | 🐛 11 | 🌐 Rust | 📅 2026-03-09 - A curated list of Rust code and resources.
