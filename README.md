...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,510 | 🐛 126 | 🌐 Rust | 📅 2026-04-01

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,510 | 🐛 126 | 🌐 Rust | 📅 2026-04-01 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,510 | 🐛 126 | 🌐 Rust | 📅 2026-04-01 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,510 | 🐛 126 | 🌐 Rust | 📅 2026-04-01 - Smaller examples included in official repo.
...
* [candle-wasm-examples](https://github.com/huggingface/candle) ⭐ 19,862 | 🐛 635 | 🌐 Rust | 📅 2026-04-01 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use. Try our online demos: [whisper](https://huggingface.co/spaces/lmz/candle-whisper), [LLaMA2](https://huggingface.co/spaces/lmz/candle-llama2), [T5](https://huggingface.co/spaces/radames/Candle-T5-Generation-Wasm), [yolo](https://huggingface.co/spaces/lmz/candle-yolo), [Segment
  Anything](https://huggingface.co/spaces/radames/candle-segment-anything-wasm).
* [Apache Iggy](https://github.com/apache/iggy) ⭐ 4,079 | 🐛 99 | 🌐 Rust | 📅 2026-04-01 - Apache Iggy: Hyper-Efficient Message Streaming at Laser Speed.
* [webapp.rs](https://github.com/saschagrunert/webapp.rs) ⭐ 2,236 | 🐛 0 | 🌐 Rust | 📅 2026-03-26 - A web application completely written in Rust, frontend is built with Yew.
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,728 | 🐛 113 | 🌐 Rust | 📅 2026-04-01 - Zoom clone written in rust for research purposes.
...
* [Realworld example](https://github.com/jetli/rust-yew-realworld-example-app) ⭐ 891 | 🐛 6 | 🌐 Rust | 📅 2026-03-16 - Exemplary real world app built with Rust + Yew + WebAssembly. It utilizes Yew's latest `function components` and `hooks`. It also supports desktop application powered by [Tauri](https://github.com/tauri-apps/tauri) ⭐ 104,820 | 🐛 1,389 | 🌐 Rust | 📅 2026-04-01.
* [PinePods](https://github.com/madeofpendletonwool/PinePods) ⭐ 828 | 🐛 142 | 🌐 Rust | 📅 2026-03-18 - PinePods is a Rust based podcast management system that manages podcasts with multi-user support and relies on a central database with clients to connect to it.
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 523 | 🐛 5 | 🌐 Rust | 📅 2026-03-30 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
...
* [Sentry Relay](https://github.com/getsentry/relay) ⭐ 365 | 🐛 102 | 🌐 Rust | 📅 2026-04-01 - The Sentry Relay is a service that pushes some functionality from the Sentry SDKs as well as the Sentry server into a proxy process.
...
* [Taxy](https://github.com/picoHz/taxy/tree/main) ⭐ 198 | 🐛 5 | 🌐 Rust | 📅 2025-04-06 - A reverse proxy server with built-in WebUI, supporting TCP/HTTP/TLS/WebSocket, written in Rust.
...
* [Google Wasefire](https://github.com/google/wasefire) ⭐ 160 | 🐛 66 | 🌐 Rust | 📅 2026-04-01 - Secure firmware framework focusing on developer experience.
...
* [web-view todomvc desktop app](https://github.com/Extrawurst/rust-webview-todomvc-yew) ⭐ 108 | 🐛 15 | 🌐 Rust | 📅 2023-01-20 - Demo how to use yew for a todomvc that compiles to WebAssembly and is bundled as a lightweight(\~2mb) desktop app by [web-view](https://github.com/Boscop/web-view) ⭐ 1,948 | 🐛 117 | 🌐 JavaScript | 📅 2024-05-09, as an alternative to Electron, [web-view](https://github.com/Boscop/web-view) ⭐ 1,948 | 🐛 117 | 🌐 JavaScript | 📅 2024-05-09 also has a [demo](https://github.com/Boscop/web-view/tree/master/examples#todo-yew) ⭐ 1,948 | 🐛 117 | 🌐 JavaScript | 📅 2024-05-09.
* [Syre](https://github.com/syre-data/syre) ⭐ 106 | 🐛 3 | 🌐 Rust | 📅 2025-09-01 - Scientific data management and insights.
* [live-ask.com](https://github.com/liveask/liveask) ⭐ 103 | 🐛 8 | 🌐 Rust | 📅 2026-03-31 - Realtime Event/Meetup Q\&A Platform. [Live at live-ask.com](https://live-ask.com).
...
* [simply-view-image-for-python-debugging](https://github.com/elazarcoh/simply-view-image-for-python-debugging?tab=readme-ov-file) ⭐ 73 | 🐛 20 | 🌐 Rust | 📅 2026-03-27 - Visual studio code extension simply view the image of the image variables when debugging python.
...
* [Rust Audio](https://github.com/austintheriot/audio) ⭐ 55 | 🐛 2 | 🌐 Rust | 📅 2026-04-01 - Realtime audio processing / synthesis using Rust/WASM in the browser, [Live Demo](https://austintheriot.github.io/audio/).
...
* [Hikari](https://github.com/celestia-island/hikari) ⭐ 21 | 🐛 0 | 🌐 Rust | 📅 2026-04-01 - The Frontend of Everything.
...
* [yew-nav-link](https://github.com/RAprogramm/yew-nav-link) ⭐ 5 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-01 - A navigational link that is aware of its active state based on the current route in the application.
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 7 | 🌐 Rust | 📅 2026-03-30 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 43,964 | 🐛 654 | 🌐 TypeScript | 📅 2026-01-20 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,938 | 🐛 251 | 🌐 TypeScript | 📅 2026-03-29.
* [Bounce](https://github.com/bounce-rs/bounce) ⭐ 100 | 🐛 14 | 🌐 Rust | 📅 2026-03-30 - The uncomplicated state management library for Yew, inspired by [Redux](https://github.com/reduxjs/redux) ⭐ 61,445 | 🐛 41 | 🌐 TypeScript | 📅 2026-03-31 and [Recoil](https://github.com/facebookexperimental/Recoil) ⚠️ Archived.
...
* [yew-side-effect](https://github.com/futursolo/yew-side-effect) ⚠️ Archived - Reconcile Side Effects in Yew Applications, inspired by [react-side-effect](https://github.com/gaearon/react-side-effect) ⭐ 1,217 | 🐛 15 | 🌐 JavaScript | 📅 2023-03-04 and [react-helmet](https://github.com/nfl/react-helmet) ⭐ 17,491 | 🐛 220 | 🌐 JavaScript | 📅 2023-07-18.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 8,935 | 🐛 543 | 🌐 Rust | 📅 2026-04-01 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [tauri-sys](https://github.com/JonasKruckenberg/tauri-sys) ⭐ 122 | 🐛 23 | 🌐 Rust | 📅 2026-04-01 - Raw bindings to the Tauri API for projects using wasm-bindgen.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 104,820 | 🐛 1,389 | 🌐 Rust | 📅 2026-04-01 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,425 | 🐛 523 | 🌐 WebAssembly | 📅 2026-04-02 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 7,937 | 🐛 220 | 🌐 C++ | 📅 2026-03-26 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,138 | 🐛 396 | 🌐 Rust | 📅 2026-03-24 - Your favorite Rust -> WebAssembly workflow tool.
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,225 | 🐛 127 | 🌐 Rust | 📅 2026-03-13 - Build, bundle & ship your Rust Wasm application to the web.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 35,501 | 🐛 672 | 🌐 Rust | 📅 2026-03-31 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 20,498 | 🐛 141 | 🌐 Rust | 📅 2026-03-30 - Build fast web applications with Rust.
* [Seed](https://github.com/seed-rs/seed) ⭐ 3,834 | 🐛 55 | 🌐 Rust | 📅 2025-01-11 - A Rust framework for creating web apps.
* [Sycamore](https://github.com/sycamore-rs/sycamore) ⭐ 3,277 | 🐛 33 | 🌐 Rust | 📅 2026-04-01 - A reactive library for creating web apps in Rust and WebAssembly.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 56,502 | 🐛 13 | 🌐 Rust | 📅 2026-04-01 - A curated list of Rust code and resources.
* [Awesome WebAssembly](https://github.com/mbasso/awesome-wasm) ⭐ 9,522 | 🐛 60 | 📅 2024-11-15 - Collection of awesome things regarding WebAssembly ecosystem.
