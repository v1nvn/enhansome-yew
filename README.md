...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,507 | 🐛 126 | 🌐 Rust | 📅 2026-04-01

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,507 | 🐛 126 | 🌐 Rust | 📅 2026-04-01 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,507 | 🐛 126 | 🌐 Rust | 📅 2026-04-01 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,507 | 🐛 126 | 🌐 Rust | 📅 2026-04-01 - Smaller examples included in official repo.
...
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,726 | 🐛 114 | 🌐 Rust | 📅 2026-03-31 - Zoom clone written in rust for research purposes.
...
* [Realworld example](https://github.com/jetli/rust-yew-realworld-example-app) ⭐ 891 | 🐛 6 | 🌐 Rust | 📅 2026-03-16 - Exemplary real world app built with Rust + Yew + WebAssembly. It utilizes Yew's latest `function components` and `hooks`. It also supports desktop application powered by [Tauri](https://github.com/tauri-apps/tauri) ⭐ 104,791 | 🐛 1,386 | 🌐 Rust | 📅 2026-04-01.
* [PinePods](https://github.com/madeofpendletonwool/PinePods) ⭐ 830 | 🐛 142 | 🌐 Rust | 📅 2026-03-18 - PinePods is a Rust based podcast management system that manages podcasts with multi-user support and relies on a central database with clients to connect to it.
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 516 | 🐛 5 | 🌐 Rust | 📅 2026-03-30 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
...
* [Sentry Relay](https://github.com/getsentry/relay) ⭐ 365 | 🐛 105 | 🌐 Rust | 📅 2026-03-31 - The Sentry Relay is a service that pushes some functionality from the Sentry SDKs as well as the Sentry server into a proxy process.
...
* [Google Wasefire](https://github.com/google/wasefire) ⭐ 160 | 🐛 64 | 🌐 Rust | 📅 2026-03-24 - Secure firmware framework focusing on developer experience.
...
* [yew-nav-link](https://github.com/RAprogramm/yew-nav-link) ⭐ 5 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-01 - A navigational link that is aware of its active state based on the current route in the application.
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 7 | 🌐 Rust | 📅 2026-03-30 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 43,962 | 🐛 654 | 🌐 TypeScript | 📅 2026-01-20 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,939 | 🐛 251 | 🌐 TypeScript | 📅 2026-03-29.
* [Bounce](https://github.com/bounce-rs/bounce) ⭐ 100 | 🐛 14 | 🌐 Rust | 📅 2026-03-30 - The uncomplicated state management library for Yew, inspired by [Redux](https://github.com/reduxjs/redux) ⭐ 61,447 | 🐛 41 | 🌐 TypeScript | 📅 2026-03-31 and [Recoil](https://github.com/facebookexperimental/Recoil) ⚠️ Archived.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 8,931 | 🐛 543 | 🌐 Rust | 📅 2026-04-01 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 104,791 | 🐛 1,386 | 🌐 Rust | 📅 2026-04-01 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,424 | 🐛 522 | 🌐 WebAssembly | 📅 2026-03-31 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 7,935 | 🐛 218 | 🌐 C++ | 📅 2026-03-26 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,137 | 🐛 396 | 🌐 Rust | 📅 2026-03-24 - Your favorite Rust -> WebAssembly workflow tool.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 35,491 | 🐛 667 | 🌐 Rust | 📅 2026-03-31 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 20,491 | 🐛 138 | 🌐 Rust | 📅 2026-03-30 - Build fast web applications with Rust.
* [Seed](https://github.com/seed-rs/seed) ⭐ 3,834 | 🐛 55 | 🌐 Rust | 📅 2025-01-11 - A Rust framework for creating web apps.
* [Sycamore](https://github.com/sycamore-rs/sycamore) ⭐ 3,216 | 🐛 33 | 🌐 Rust | 📅 2026-04-01 - A reactive library for creating web apps in Rust and WebAssembly.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 56,484 | 🐛 11 | 🌐 Rust | 📅 2026-03-31 - A curated list of Rust code and resources.
* [Awesome WebAssembly](https://github.com/mbasso/awesome-wasm) ⭐ 9,520 | 🐛 59 | 📅 2024-11-15 - Collection of awesome things regarding WebAssembly ecosystem.
